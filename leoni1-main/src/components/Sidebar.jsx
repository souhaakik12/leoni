...
const allNavItems = [
  ...
  {
    path: "/contracts/reception",
    label: "Dossiers Contrat",
    roles: CONTRACT_ACCESS_ROLES,
    icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M9 12h6"/><path d="M9 16h6"/><path d="M9 8h6"/><path d="M4 5a2 2 0 0 1 2-2h8l6 6v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z"/></svg>,
  },
  {
